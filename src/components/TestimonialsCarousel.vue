<template>
  <section ref="sectionRef" class="relative w-full py-24 scroll-animate">
    <div class="max-w-[1440px] mx-auto px-12">
      ...
      <div class="max-w-[1000px]">
        <div class="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-16 mb-12 min-h-[320px]">
          <div class="flex justify-center lg:justify-start">
            <img
              class="w-full max-w-[280px] h-auto aspect-[280/320] object-cover shadow-sm"
          ...
          <div class="flex flex-col justify-between min-h-[280px]">
            <div class="min-h-[180px]">
              <p class="font-family-jakarta font-normal text-[#1e1d1b]/80 text-lg leading-[1.7]">
                {{ currentTestimonial.quote }}
              </p>
            </div>

            <div class="flex flex-col gap-1">
              <h3 class="font-family-roboto font-semibold text-[#1e1d1b] text-2xl leading-[1.3]">
                {{ currentTestimonial.author }}
              </h3>
              <p class="font-family-jakarta font-normal text-[#1e1d1b]/60 text-base leading-[1.5]">
