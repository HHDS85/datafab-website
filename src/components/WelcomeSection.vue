<template>
  <section ref="sectionRef" class="relative w-full bg-[#F4F5F7] py-28 xl:py-32 scroll-animate">
    <div class="max-w-[1920px] mx-auto px-8 lg:px-16 xl:px-20 2xl:px-24">
      <div class="mb-12">
        <p class="font-family-jakarta font-medium text-[#1e1d1b] text-sm xl:text-[15px] tracking-[0.05em] uppercase">
          WILLKOMMEN
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 xl:gap-32">
        ...
        <div class="flex flex-col justify-start gap-8">
          <p class="font-family-jakarta font-normal text-[#1e1d1b] text-lg xl:text-xl leading-[1.75]">
