<template>
  <section ref="sectionRef" class="relative w-full bg-[#F4F5F7] py-16 md:py-20 scroll-animate">
    <div class="max-w-[1440px] mx-auto px-6 lg:px-12 xl:px-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 lg:gap-16 xl:gap-20">
        ...
        <div class="flex flex-col justify-start gap-5 md:gap-6">
          <p class="font-family-jakarta font-normal text-[#1e1d1b] text-sm md:text-base leading-[1.7] md:leading-[1.75]">
            {{ t('welcome.intro') }}
          </p>
